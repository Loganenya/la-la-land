package com.lala.land.service.impl;
...
import com.lala.land.constant.CommonConstant;
import com.lala.land.exception.ThrowUtils;
import com.lala.land.mapper.AppMapper;
import com.lala.land.model.dto.app.AppQueryRequest;
import com.lala.land.model.entity.App;
import com.lala.land.model.entity.User;
import com.lala.land.model.enums.AppScoringStrategyEnum;
import com.lala.land.model.enums.AppTypeEnum;
import com.lala.land.model.enums.ReviewStatusEnum;
import com.lala.land.model.vo.AppVO;
import com.lala.land.model.vo.UserVO;
import com.lala.land.service.AppService;
import com.lala.land.service.UserService;
import com.lala.land.utils.SqlUtils;
...
public class AppServiceImpl extends ServiceImpl<AppMapper, App> implements AppService {
    ...
    public QueryWrapper<App> getQueryWrapper(AppQueryRequest appQueryRequest) {
        ...
        queryWrapper.eq(ObjectUtils.isNotEmpty(id), "appType", appType);
        queryWrapper.eq(ObjectUtils.isNotEmpty(id), "scoringStrategy", scoringStrategy);
        queryWrapper.eq(ObjectUtils.isNotEmpty(id), "reviewStatus", reviewStatus);
        queryWrapper.eq(ObjectUtils.isNotEmpty(id), "reviewerId", reviewerId);
